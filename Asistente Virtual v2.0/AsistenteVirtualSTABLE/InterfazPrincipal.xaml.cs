...
namespace AsistenteVirtualSTABLE
{
    public partial class InterfazPrincipal : Window
    {
        ...
        {
                MessageBox.Show("Parece que el programador no tiene ideas... Ese programador es todo un loquillo");
        } 
        ...
        private void pb_Audio_ValueChanged(object sender, RoutedPropertyChangedEventArgs<double> e)
        {
